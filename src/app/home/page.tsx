...
import { Music, Calendar, Users, BarChart3, Search, X, Home, User, Bell, HelpCircle, Flag, Play, ChevronDown, ChevronUp, Info, Shield, Lock, Mic } from 'lucide-react'
                      ...
                      <Tooltip key={index} text={tooltip}>
                        ...
                        >
                          <div className="relative mb-2">
                            <div className={`w-8 h-8 bg-gradient-to-br rounded-lg flex items-center justify-center transition-all duration-300 shadow-sm ${isPremiumFeature && !hasAccess
                          ...
                          <span className={`text-xs font-medium text-center leading-tight transition-colors duration-300 ${isPremiumFeature && !hasAccess
