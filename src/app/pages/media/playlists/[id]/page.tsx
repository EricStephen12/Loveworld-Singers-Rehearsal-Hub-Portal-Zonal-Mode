...
import { getPlaylist, removeFromPlaylist, Playlist } from '../../_lib/playlist-service'
import { firebaseMediaService } from '../../_lib/firebase-media-service'
import { ArrowLeft, Play, Shuffle, MoreVertical, Trash2, ListVideo } from 'lucide-react'
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="p-4">
            ...
            <p className="text-gray-500 text-sm mb-4">{videos.length} videos</p>
                    ...
                    <div className="relative">
                      ...
                      {menuOpen === video.id && (
                        <>
                          ...
                          <div className="absolute right-0 top-10 bg-[#282828] rounded-lg shadow-xl z-20 py-1 min-w-[180px]">
                            <button
                              onClick={() => handleRemoveVideo(video.id)}
                              className="flex items-center gap-3 w-full px-4 py-2 hover:bg-white/10"
                            >
