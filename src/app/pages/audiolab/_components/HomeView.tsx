      ...
      <main className="relative z-10 flex flex-col gap-4 sm:gap-6 px-3 sm:px-4 pt-4 sm:pt-6">
        ...
        <div className="flex-1 flex flex-col items-center px-2 overflow-y-auto">
          ...
          <div className="mb-6 sm:mb-8 text-center">
            <div className="size-16 sm:size-20 mx-auto mb-3 sm:mb-4 rounded-2xl bg-gradient-to-br from-violet-500 to-purple-600 flex items-center justify-center shadow-lg shadow-violet-500/30">
              <Mic size={32} className="sm:w-[40px] sm:h-[40px] text-white" />
            </div>
            <h1 className="text-xl sm:text-2xl font-bold text-white">AudioLab</h1>
          </div>
