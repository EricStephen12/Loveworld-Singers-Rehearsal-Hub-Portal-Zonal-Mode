    ...
    const draw = () => {
      ...
      for (let i = 0; i < barCount; i++) {
        ...
        if (isRecording) {
          ...
          barHeight = (0.3 + combinedWave * levelBoost) * rect.height * 0.85;
