...
export default function KaraokeConfigSection() {
    ...
    const openConfigModal = async (song: MasterSong) => {
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-white font-bold text-lg">{masterSongs.length} songs</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="bg-slate-50 border-b border-slate-200">
                                    ...
                                    <th className="px-6 py-4 text-xs font-semibold text-slate-500 uppercase tracking-wider w-[30%]">Lead Singer</th>
                                    <th className="px-6 py-4 text-xs font-semibold text-slate-500 uppercase tracking-wider text-right w-[30%]">Actions</th>
                                </tr>
                            </thead>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        <div className="flex items-center justify-between mb-2">
                                            ...
                                            <span className="text-xs text-slate-500 bg-slate-100 px-2 py-1 rounded">Autosaves manually</span>
                                        </div>
                                        <textarea
                                            value={lrcText}
