module.exports = [
"[project]/src/lib/check-coordinator.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function isUserCoordinator(userId) {
    try {
        ...
        const memberships = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$database$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["FirebaseDatabaseService"].getCollectionWhere('zone_members', 'userId', '==', userId);
...
//# sourceMappingURL=src_lib_check-coordinator_ts_6df7553b._.js.map