module.exports = [
"[project]/src/lib/analytics-aggregation-service.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class AnalyticsAggregationService {
    ...
    static async getOrCreateMonthlySummary(year, month) {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["setDoc"])(docRef, newSummary);
        return newSummary;
    }
    static async incrementEvent(timestamp, eventType, page, featureName, songId) {
        ...
        try {
            const updates = {
                totalEvents: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["increment"])(1),
                updatedAt: new Date()
            };
            switch(eventType){
                case 'signup':
                    updates.totalSignups = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["increment"])(1);
                    break;
                case 'login':
                    updates.totalLogins = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["increment"])(1);
                    break;
                case 'feature_engagement':
                    updates.totalFeatureEngagements = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["increment"])(1);
                    if (page) {
                        updates[`pageViews.${page.replace(/\//g, '_')}`] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["increment"])(1);
                    }
                    if (featureName) {
                        updates[`featureEngagements.${featureName.replace(/\//g, '_')}`] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["increment"])(1);
                    }
                    if (songId) {
                        updates[`songAccesses.${songId.replace(/\//g, '_')}`] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["increment"])(1);
                    }
                    break;
            }
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["updateDoc"])(docRef, updates);
        } catch (error) {
...
//# sourceMappingURL=src_lib_analytics-aggregation-service_ts_c1ab3354._.js.map